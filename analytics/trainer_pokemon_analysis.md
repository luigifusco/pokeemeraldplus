...
- Graph density **0.035**, Louvain modularity **0.581**, **25** communities
...
| 10 | Lombre + Nuzleaf | 8 | Collector EDWIN |
| 11 | Delcatty + Roselia | 8 | Rival WALLY |
...
| 18 | Machop + Machoke | 6 | Black Belt HITOSHI |
...
| 25 | Seviper + Kecleon | 5 | Beauty JESSICA |
...
**Cluster 3** — 33 species: Linoone, Mightyena, Manectric, Swellow, Magneton, Loudred, Spinda, Aron, Slaking, Shiftry, Vigoroth, Dodrio (+21 more)

**Cluster 20** — 21 species: Pelipper, Lombre, Slugma, Altaria, Tropius, Skarmory, Nuzleaf, Doduo, Ludicolo, Grovyle, Combusken, Marshtomp (+9 more)

**Cluster 9** — 20 species: Wingull, Carvanha, Wailmer, Tentacool, Machoke, Machop, Staryu, Sharpedo, Tentacruel, Gyarados, Starmie, Magikarp (+8 more)

**Cluster 0** — 18 species: Geodude, Sandshrew, Sandslash, Baltoy, Graveler, Kecleon, Nosepass, Seviper, Golem, Zangoose, Onix, Kabutops (+6 more)

**Cluster 22** — 18 species: Kadabra, Xatu, Lunatone, Solrock, Claydol, Natu, Wobbuffet, Mawile, Slowpoke, Aggron, Alakazam, Hypno (+6 more)

**Cluster 1** — 17 species: Makuhita, Zubat, Zigzagoon, Meditite, Poochyena, Magnemite, Electrike, Taillow, Skitty, Lotad, Kirlia, Voltorb (+5 more)

**Cluster 16** — 16 species: Luvdisc, Whiscash, Kingdra, Crawdaunt, Walrein, Wailord, Sealeo, Shelgon, Poliwhirl, Lapras, Glalie, Flygon (+4 more)

**Cluster 8** — 15 species: Roselia, Numel, Marill, Shroomish, Breloom, Goldeen, Delcatty, Gloom, Swablu, Azumarill, Seaking, Gardevoir (+3 more)

**Cluster 19** — 13 species: Hariyama, Medicham, Sableye, Machamp, Spoink, Banette, Duskull, Hitmontop, Shuppet, Dusclops, Hitmonchan, Grumpig (+1 more)

**Cluster 23** — 11 species: Ninjask, Koffing, Dustox, Surskit, Beautifly, Wurmple, Nincada, Masquerain, Silcoon, Cascoon, Weezing

**Cluster 18** — 10 species: Camerupt, Torkoal, Magcargo, Mudkip, Ponyta, Growlithe, Rapidash, Houndour, Arcanine, Houndoom

**Cluster 21** — 2 species: Minun, Plusle

**Cluster 4** — 2 species: Volbeat, Illumise

**Cluster 15** — 1 species: Slakoth

**Cluster 17** — 1 species: Wigglytuff

**Cluster 13** — 1 species: Abra

**Cluster 14** — 1 species: Girafarig

**Cluster 24** — 1 species: Castform

**Cluster 2** — 1 species: Pinsir

**Cluster 5** — 1 species: Beldum

**Cluster 6** — 1 species: Chimecho

**Cluster 7** — 1 species: Charmander

**Cluster 10** — 1 species: Bulbasaur

**Cluster 11** — 1 species: Groudon

**Cluster 12** — 1 species: Kyogre
