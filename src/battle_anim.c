...
#define BATTLE_ANIM_SOFT_TIMEOUT_FRAMES DIV_ROUND_UP(10 * 60, BATTLE_ANIM_SPEED_MULTIPLIER)
#define BATTLE_ANIM_HARD_TIMEOUT_FRAMES DIV_ROUND_UP(12 * 60, BATTLE_ANIM_SPEED_MULTIPLIER)
#else
